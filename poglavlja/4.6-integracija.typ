...
- _GitHub_ користи HMAC-SHA256 потпис који се шаље у заглављу `X-Hub-Signature-256` @githubwebhook.

- _GitLab_ користи токен у заглављу `X-Gitlab-Token` @gitlabwebhook.
