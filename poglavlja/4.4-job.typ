...
Сваком послу се додељује јединствени идентификатор, назив и опис, као и агент на ком ће се извршавати.Поред тога, у оквиру исте форме могуће је дефинисати webhook адресе за _Slack_ и _Microsoft Teams_, чиме се омогућава слање нотификација о статусу извршавања директно на изабрану платформу.
На Слици @fig:job-forma-webhook је приказан део форме за креирање посла са уносом основних информација и webhook адреса
#figure(
[
#box(width: auto, image("../slike/job_forma_webhook.png"));
],
caption: [
Део форме за креирање посла са уносом основних информација и webhook адреса.
]
...
На Слици @fig:properties је приказан пример форме за дефинисање различитих типова параметара (properties) који се могу користити у послу.
#figure(
[
