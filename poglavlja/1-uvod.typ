...
_Runner_-и могу бити _GitHub Hosted_ или _Self-Hosted_ @github_runners. _GitHub Hosted_ је _cloud_ инстанца коју обезбјеђује _GitHub_. Мастер логика је имплицитно интегрисана у _GitHub_ платформу. Она управља оркестрацијом и надзором извршавања радних токова.
...
Комуникација између _GitLab Server_-а и _Runner_-а одвија се преко HTTP(S) протокола. _Runner_-и активно контактирају _GitLab Server_ преко API-ја и преузимају послове. Сва комуникација је шифрована путем TLS-а, што обезбјеђује сигурност података @gitlab_architecture.
